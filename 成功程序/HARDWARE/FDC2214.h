...
#define slave_ADDR1 0x2A
#define slave_ADDR2 0x2B
...
uint8_t FDC2214_GetChannelData(u8 DEVICE,FDC2214_channel_t channel, uint32_t *data);
void FDC2214_SetRcount(uint8_t Slve_Addr,FDC2214_channel_t channel, uint16_t rcount); //change
