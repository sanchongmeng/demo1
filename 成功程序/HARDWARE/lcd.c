...
//void LCD_DrawST(void)
//{
//	int time = 0;
//	for(time = 0 ; time < st_NUM ; time++)
//		LCD_DrawPoint(x_st[time] + x_offset ,y_st[time] + y_offset );
//}

//void LCD_DrawJD(void)
//{
//	int time = 0;
//	for(time = 0 ; time < jd_NUM ; time++)
//		LCD_DrawPoint(x_jd[time] + x_offset ,y_jd[time] + y_offset );
//}

//void LCD_DrawBU(void)
//{
//	int time = 0;
//	for(time = 0 ; time < bu_NUM ; time++)
//		LCD_DrawPoint(x_bu[time] + x_offset ,y_bu[time] + y_offset );
//}

//void LCD_DrawFIG1(void)
//{
//	int time = 0;
//	for(time = 0 ; time < fig1_NUM ; time++)
//		LCD_DrawPoint(x_fig1[time] + x_offset ,y_fig1[time] + y_offset );
//}

//void LCD_DrawFIG2(void)
//{
//	int time = 0;
//	for(time = 0 ; time < fig2_NUM ; time++)
//		LCD_DrawPoint(x_fig2[time] + x_offset ,y_fig2[time] + y_offset );
//}

//void LCD_DrawFIG3(void)
//{
//	int time = 0;
//	for(time = 0 ; time < fig3_NUM ; time++)
//		LCD_DrawPoint(x_fig3[time] + x_offset ,y_fig3[time] + y_offset );
//}

//void LCD_DrawFIG4(void)
//{
//	int time = 0;
//	for(time = 0 ; time < fig4_NUM ; time++)
//		LCD_DrawPoint(x_fig4[time] + x_offset ,y_fig4[time] + y_offset );
//}

//void LCD_DrawFIG5(void)
//{
//	int time = 0;
//	for(time = 0 ; time < fig5_NUM ; time++)
//		LCD_DrawPoint(x_fig5[time] + x_offset ,y_fig5[time] + y_offset );
//}


//void LCD_DrawPic(u8 pic_num)
//{
//		LCD_Fill(0,70,240,320,WHITE);
//		LCD_ShowString(20,80,240,16,16,"GESTURE RECOGNITION RESULT:");
//		LCD_ShowString(20,100,240,16,16,"Key1:Exit");
//	
//		switch(pic_num)
//		{
//			case 0 ://石头
